...
export function Part() {
  return(
    <div className="relative bg-custom-yellow inline-block border-solid border-2 border-black rounded-3xl h-1/2 w-1/2">
      <h2 className="relative text-5xl left-96 mb-2 ">Participation</h2> 
